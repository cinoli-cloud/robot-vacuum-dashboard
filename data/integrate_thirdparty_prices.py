    ...
    for product in products:
        ...
        if key in price_map:
            ...
            if prices_data.get('bestbuy') and 'channels' in product:
                ...
                product['channels']['bestbuy']['price_source'] = 'Playwright Scraper'
            ...
            if prices_data.get('ebay') and 'channels' in product and 'ebay' in product['channels']:
                ...
                product['channels']['ebay']['price_source'] = 'Playwright Scraper'
